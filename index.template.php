...
<head>';
	...
	echo '
	<script  src="', $settings['theme_url'], '/scripts/popper.min.js"></script>
	...
	<script  src="', $settings['theme_url'], '/scripts/webslidemenu.js?fin20"></script>
...
<div class="page">
	<div class="page-main">
		<header class="p-header" id="header_ust">
			<!-- app-content-->
			<div class="d-block d-md-none navbar-sm-search">
				<!-- Form -->
				<form class="navbar-search p-2 navbar-search-dark form-inline ml-lg-auto" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '">
			...
			<nav class="navbar navbar-top navbar-expand navbar-dark" id="navbar-main">
				<div class="container">
					...
					<a class="navbar-brand" href="', $scripturl, '">', empty($context['header_logo_url_html_safe']) ? $context['forum_name'] : '<img src="' . $context['header_logo_url_html_safe'] . '" alt="' . $context['forum_name'] . '" class="forumtitle"  />', '</a>
					<!-- Form -->
					<form class="search navbar-search navbar-search-dark form-inline ml-3  ml-auto" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '">
						<div class="d-none d-md-block search__wrapper pr-md-0 mr-md-2 pl-1">
					...
					if ($context['allow_pm'])
						if ($context['user']['unread_messages'] == 0) {
							...
							$user_messages = $context['user']['unread_messages'];
						}
						echo '
						<a class="nav-link p-navgroup-link d-flex" href="', $scripturl, '?action=pm" data-toggle="tooltip" data-placement="bottom" title="', $txt['pm'], '"><i class="fa fa-envelope"></i><span class="badge badge-danger badge-pill noti-icon-badge">', $user_messages, '</span></a>';
						if ($user_settings['unread_mentions'] == 0) {
							$user_mentions = '';
						} else {
							$user_mentions = $user_settings['unread_mentions'];			
						}
				        echo '
						<a class="nav-link p-navgroup-link d-flex" href="', $scripturl, '?action=profile;area=mentions" data-toggle="tooltip" data-placement="bottom" title="', $txt['mentions'], '"><i class="fa fa-at"></i><span class="badge badge-danger badge-pill noti-icon-badge">', $user_mentions, '</span></a>';
				        echo '
						...
						echo '
							...
							<span class="user-name d-none d-sm-block float-right">', $context['user']['name'], ' <span class="caret"></span>
							</span></a>';
...
function template_body_below()
{
   ...
   <!--les liens vers les réseaux-->
	...
	<!--le logo DMF-->
		...
		<div id="footer-right" class="footerdivs2">
		<!--les logos des partenaires-->
			<div><a class="desmo4all" alt="Desmo4all" href="https://www.desmo4all.com/"></a></div>
			<div><a class="steindinse" alt="Stein Dinse" href="http://www.stein-dinse.biz/index.php?language=fr"></a></div>
			<div><a class="devmoto" alt="DEVmoto"  href="http://www.devmoto.com/"></a></div>
		</div>
		<div id="footer-right" class="footerdivs2">
			<div><a class="sprido" alt="Sprido peinture" href="http://www.sprido-peinture.com/"></a></div>
			<div><a class="bikerevival" alt="Bike Revival" href="http://www.bike-revival.fr/"></a></div>
		</div>
		<div id="footer-right" class="footerdivs2">
			<div><a class="ducatitoulouse" alt="Ducati Toulouse" href="http://www.ducatitoulouse.fr/fr/"></a></div>
			<div><a class="gb" alt="GB motorcycle products" href="https://www.gbmotorcycleproducts.com/"></a></div>
		</div>
	</div>
		</div>
...
<div class="container">
<div class="frame">
<p class="copyright">', theme_copyright(), '| ' , $txt['wt_copyright'], '</p>
